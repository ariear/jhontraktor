    ...
    return (
        <div className="bg-[url('/img/bluri.png')] bg-cover bg-center relative">
            ...
            <div className="container mx-auto text-white py-16 z-10 relative">
                ...
                <div className="flex items-center justify-evenly mb-14">
                    <p className="flex items-center text-lg font-medium"><Image src='/icons/check.png' alt="" width={20} height={0} className="mr-2" /> Proffesional Staff</p>
                    <p className="flex items-center text-lg font-medium"><Image src='/icons/check.png' alt="" width={20} height={0} className="mr-2" /> 100% Satisfacion</p>
                    <p className="flex items-center text-lg font-medium"><Image src='/icons/check.png' alt="" width={20} height={0} className="mr-2" /> Accurate Testing</p>
                ...
                <div className="flex mx-auto w-max">
                    <div className="bg-[#FF7420] p-8 rounded-xl w-[800px] mr-10">
                    ...
                    <div className="bg-[#FF7420] w-[400px] p-8 rounded-xl">
