...
const Main = () => {
    return (
        <div className="bg-[url('/img/main.png')] bg-cover bg-center py-32 xl:px-0 sm:px-8 px-4" id="home" >
            <div className="text-white relative container mx-auto">
                <p className="text-6xl mb-6 font-semibold sm:w-[450px] leading-[60px]">We Prepare For The <o className="text-[#FF7420]">Future</o></p>
                <p className="sm:w-[480px]">We provide the best architectural design, contruction, and building maintance services for you.</p>
